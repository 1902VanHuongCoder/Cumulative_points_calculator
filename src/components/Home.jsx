...
const Home = () => {
  return (
    <div className="relative w-full min-h-screen sm:overflow-hidden bg-gradient-to-tr from-cyan-300 to-pink-600">
      <div
      ...
      >
        ...
        <div className="w-full sm:flex">
          <div className={`w-full sm:w-2/3 h-fit mb-16`}>
            <div className="w-[90%] mx-auto">
              <ul className="flex justify-evenly font-bold text-white px-1 text-center sm:text-left text-[10px] sm:text-[16px] mb-3">
                <li className="basis-[8%]">STT</li>
                <li className="basis-[34%] break-all">Subject Name</li>
                <li className="basis-[14%]">No. Cre</li>
                <li className="basis-[12%]">Score</li>
                <li className="basis-[12%]">Semester</li>
                <li className="basis-[20%]">Year</li>
              </ul>
              {subjectList.map((item, index) => {
                return (
                  <ul
                    ...
                    }  flex justify-evenly items-center mb-1 px-4 text-center text-[12px] sm:text-[16px] rounded-lg`}
                  >
                    <li className="basis-[8%]">{item}</li>
                    <li className="basis-[34%] text-left">
                      Analyze and Design System
                    </li>
                    <li className="basis-[14%]">3</li>
                    <li className="basis-[14%]">C</li>
                    <li className="basis-[14%]">1</li>
                    <li className="basis-[14%]">2023 - 2024</li>
                  </ul>
                );
              })}
            </div>
          ...
          <div
            className={`w-full sm:w-1/3 h-[${
              window.innerHeight - 80
            }px] flex flex-col gap-y-5`}
          >
